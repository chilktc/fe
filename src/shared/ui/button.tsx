...
export function Button({
  ...
  const baseStyles =
    "flex items-center justify-center px-4 py-2 rounded-[10px] font-semibold transition-colors hover:cursor-pointer focus:outline-none text-button-1 disabled:cursor-not-allowed";
