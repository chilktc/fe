...
export const PODCAST_CHOICES: PodcastChoiceDetail[] = [
  {
    imageUrl: "/assets/images/podcast-image-1.png",
    type: ["위로", "따뜻함", "공감"],
    title: "따뜻한 공감자",
    description: "부드러운 목소리로 마음을 안아주며 위로를 전하는 스타일",
  },
  {
    imageUrl: "/assets/images/podcast-image-2.png",
    type: ["논리", "해결책", "정리"],
    title: "이성적인 분석가",
    description:
  ...
  {
    imageUrl: "/assets/images/podcast-image-3.png",
    type: ["응원", "변화", "열정"],
    title: "열정적인 코치",
    description: "에너지가 넘치고 동기부여를 주며 강력하게 응원하는 스타일",
  },
  {
    imageUrl: "/assets/images/podcast-image-4.png",
    type: ["통찰", "차분함", "깊이"],
    title: "고요한 새벽지기",
  ...
  {
    imageUrl: "/assets/images/podcast-image-7.png",
    type: ["전문성", "신뢰", "가이드"],
    title: "신뢰의 전문가",
    description: "격식과 권위 있는 말투로 신뢰감 있는 조언을 하는 스타일",
  },
  {
    imageUrl: "/assets/images/podcast-image-8.png",
    type: ["친근함", "소탈함", "편안함"],
    title: "편안한 동네 친구",
...
function getDistinctChoiceIndexes(asciiCode: number, totalCount: number) {
  ...
  const secondIndex = secondSeed >= firstIndex ? secondSeed + 1 : secondSeed;
